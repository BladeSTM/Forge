...
namespace LuaCreature
{
     ...
     */
    int IsRegeneratingHealth(Forge* F, Creature* creature)
    {
        F->Push(creature->CanRegenerateHealth());
        return 1;
    }
     ...
     */
    int SetRegeneratingHealth(Forge* F, Creature* creature)
    {
     ...
     */
    int IsReputationGainDisabled(Forge* F, Creature* creature)
    {
        F->Push(creature->IsReputationGainDisabled());
        return 1;
    }
     ...
     */
    int CanCompleteQuest(Forge* F, Creature* creature)
    {
        uint32 quest_id = F->CHECKVAL<uint32>(2);

        F->Push(creature->hasInvolvedQuest(quest_id));
        return 1;
    }
     ...
     */
    int IsTargetableForAttack(Forge* F, Creature* creature)
    {
        bool mustBeDead = F->CHECKVAL<bool>(2, false);

        F->Push(creature->isTargetableForAttack(mustBeDead));
        return 1;
    }
     ...
     */
    int CanAssistTo(Forge* F, Creature* creature)
    {
        Unit* u = F->CHECKOBJ<Unit>(2);
        Unit* enemy = F->CHECKOBJ<Unit>(3);
        bool checkfaction = F->CHECKVAL<bool>(4, true);

        F->Push(creature->CanAssistTo(u, enemy, checkfaction));
        return 1;
    }
     ...
     */
    int HasSearchedAssistance(Forge* F, Creature* creature)
    {
        F->Push(creature->HasSearchedAssistance());
        return 1;
    }
     ...
     * @return bool tapped
     */
    int IsTappedBy(Forge* F, Creature* creature)
    {
        Player* player = F->CHECKOBJ<Player>(2);

        F->Push(creature->isTappedBy(player));
        return 1;
    }
     ...
     */
    int HasLootRecipient(Forge* F, Creature* creature)
    {
        F->Push(creature->hasLootRecipient());
        return 1;
    }
     ...
     */
    int CanAggro(Forge* F, Creature* creature)
    {
        F->Push(!creature->HasFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC));
        return 1;
    }
     ...
     * @return bool canSwim
     */
    int CanSwim(Forge* F, Creature* creature)
    {
        F->Push(creature->CanSwim());
        return 1;
    }
     ...
     * @return bool canWalk
     */
    int CanWalk(Forge* F, Creature* creature)
    {
        F->Push(creature->CanWalk());
        return 1;
    }
     ...
     */
    int IsInEvadeMode(Forge* F, Creature* creature)
    {
        F->Push(creature->IsInEvadeMode());
        return 1;
    }
     ...
     * @return bool isElite
     */
    int IsElite(Forge* F, Creature* creature)
    {
        F->Push(creature->isElite());
        return 1;
    }
     ...
     * @return bool isGuard
     */
    int IsGuard(Forge* F, Creature* creature)
    {
        F->Push(creature->IsGuard());
        return 1;
    }
     ...
     */
    int IsCivilian(Forge* F, Creature* creature)
    {
        F->Push(creature->IsCivilian());
        return 1;
    }
     ...
     */
    int IsRacialLeader(Forge* F, Creature* creature)
    {
        F->Push(creature->IsRacialLeader());
        return 1;
    }
     ...
     */
    int IsDungeonBoss(Forge* F, Creature* creature)
    {
        F->Push(creature->IsDungeonBoss());
        return 1;
    }
     ...
     */
    int IsWorldBoss(Forge* F, Creature* creature)
    {
        F->Push(creature->isWorldBoss());
        return 1;
    }
     ...
     */
    int HasCategoryCooldown(Forge* F, Creature* creature)
    {
        uint32 spell = F->CHECKVAL<uint32>(2);

        if (const SpellInfo* info = sSpellMgr->GetSpellInfo(spell))
            F->Push(info->GetCategory() && creature->GetSpellHistory()->HasCooldown(spell));
        else
            F->Push(false);
     ...
     */
    int HasSpell(Forge* F, Creature* creature)
    {
        uint32 id = F->CHECKVAL<uint32>(2);

        F->Push(creature->HasSpell(id));
        return 1;
    }
     ...
     */
    int HasQuest(Forge* F, Creature* creature)
    {
        uint32 questId = F->CHECKVAL<uint32>(2);

        F->Push(creature->hasQuest(questId));
        return 1;
    }
     ...
     * @return bool hasCooldown
     */
    int HasSpellCooldown(Forge* F, Creature* creature)
    {
        uint32 spellId = F->CHECKVAL<uint32>(2);

        F->Push(creature->GetSpellHistory()->HasCooldown(spellId));
        return 1;
    }
     ...
     * @return bool canFly
     */
    int CanFly(Forge* F, Creature* creature)
    {
        F->Push(creature->CanFly());
        return 1;
    }
     ...
     * @return bool canFly
     */
    int IsTrigger(Forge* F, Creature* creature)
    {
        F->Push(creature->IsTrigger());
        return 1;
    }
     ...
     */
    int IsDamageEnoughForLootingAndReward(Forge* F, Creature* creature)
    {
        F->Push(creature->IsDamageEnoughForLootingAndReward());
        return 1;
    }
     ...
     */
    int CanStartAttack(Forge* F, Creature* creature)
    {
        Unit* target = F->CHECKOBJ<Unit>(2);
        bool force = F->CHECKVAL<bool>(3, true);

        F->Push(creature->CanStartAttack(target, force));
        return 1;
    }
     ...
     */
    int HasLootMode(Forge* F, Creature* creature)
    {
        uint16 lootMode = F->CHECKVAL<uint16>(2);

        F->Push(creature->HasLootMode(lootMode));
        return 1;
    }
     ...
     */
    int GetRespawnDelay(Forge* F, Creature* creature)
    {
        F->Push(creature->GetRespawnDelay());
        return 1;
    }
     ...
     */
    int GetWanderRadius(Forge* F, Creature* creature)
    {
        F->Push(creature->GetWanderDistance());
        return 1;
    }
     ...
     */
    int GetWaypointPath(Forge* F, Creature* creature)
    {
        F->Push(creature->GetWaypointPath());
        return 1;
    }
     ...
     * @return uint32 wpId
     */
    int GetCurrentWaypointId(Forge* F, Creature* creature)
    {
        F->Push(creature->GetCurrentWaypointInfo().first);
        return 1;
    }
     ...
     */
    int GetDefaultMovementType(Forge* F, Creature* creature)
    {
        F->Push(creature->GetDefaultMovementType());
        return 1;
    }
     ...
     */
    int GetAggroRange(Forge* F, Creature* creature)
    {
        Unit* target = F->CHECKOBJ<Unit>(2);

        F->Push(creature->GetAggroRange(target));
        return 1;
    }
     ...
     */
    int GetAttackDistance(Forge* F, Creature* creature)
    {
        Unit* target = F->CHECKOBJ<Unit>(2);

        F->Push(creature->GetAttackDistance(target));
        return 1;
    }
     ...
     */
    int GetLootRecipientGroup(Forge* F, Creature* creature)
    {
        F->Push(creature->GetLootRecipientGroup());
        return 1;
    }
     ...
     */
    int GetLootRecipient(Forge* F, Creature* creature)
    {
        F->Push(creature->GetLootRecipient());
        return 1;
    }
     ...
     */
    int GetScriptName(Forge* F, Creature* creature)
    {
        F->Push(creature->GetScriptName());
        return 1;
    }
     ...
     */
    int GetAIName(Forge* F, Creature* creature)
    {
        F->Push(creature->GetAIName());
        return 1;
    }
     ...
     */
    int GetScriptId(Forge* F, Creature* creature)
    {
        F->Push(creature->GetScriptId());
        return 1;
    }
     ...
     */
    int GetCreatureSpellCooldownDelay(Forge* F, Creature* creature)
    {
        uint32 spell = F->CHECKVAL<uint32>(2);

        if (SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(spell))
            F->Push(creature->GetSpellHistory()->GetRemainingCooldown(spellInfo));
        else
            F->Push(0);
     ...
     */
    int GetCorpseDelay(Forge* F, Creature* creature)
    {
        F->Push(creature->GetCorpseDelay());
        return 1;
    }
     ...
     * @return float o
     */
    int GetHomePosition(Forge* F, Creature* creature)
    {
        float x, y, z, o;
     ...
     * @param float o
     */
    int SetHomePosition(Forge* F, Creature* creature)
    {
    ...
    */
    int GetAITarget(Forge* F, Creature* creature)
    {
        uint32 targetType = F->CHECKVAL<uint32>(2);
        bool playerOnly = F->CHECKVAL<bool>(3, false);
        uint32 position = F->CHECKVAL<uint32>(4, 0);
        float dist = F->CHECKVAL<float>(5, 0.0f);
        int32 aura = F->CHECKVAL<int32>(6, 0);
        ...
        switch (targetType)
        {
            ...
            case SELECT_TARGET_RANDOM:
                ...
                break;
            default:
                luaL_argerror(F->L, 2, "SelectAggroTarget expected");
                break;
        }
     ...
     */
    int GetAITargets(Forge* F, Creature* creature)
    {
        auto const& threatlist = creature->GetThreatManager().GetSortedThreatList();

        lua_createtable(F->L, creature->GetThreatManager().GetThreatListSize(), 0);
     ...
     */
    int GetAITargetsCount(Forge* F, Creature* creature)
    {
        F->Push((double)creature->GetThreatManager().GetThreatListSize());
        return 1;
    }
     ...
     */
    int AddThreat(Forge* F, Creature* creature)
    {
        Unit* victim = F->CHECKOBJ<Unit>(2);
        float threat = F->CHECKVAL<float>(3, true);
        uint32 spell = F->CHECKVAL<uint32>(4, 0);
     ...
     * @return float threat
     */
    int GetThreat(Forge* F, Creature* creature)
    {
        Unit* target = F->CHECKOBJ<Unit>(2);

        F->Push(creature->GetThreatManager().GetThreat(target));
        return 1;
    }
     ...
     * @param [Unit] target
     */
    int ClearThreat(Forge* F, Creature* creature)
    {
        Unit* target = F->CHECKOBJ<Unit>(2);
     ...
     */
    int ClearThreatList(Forge* /*E*/, Creature* creature)
    {
     ...
     */
    int ResetAllThreat(Forge* /*E*/, Creature* creature)
    {
     ...
     * @param [Unit] target
     */
    int FixateTarget(Forge* F, Creature* creature)
    {
        Unit* target = F->CHECKOBJ<Unit>(2);
     ...
     */
    int ClearFixate(Forge* /*E*/, Creature* creature)
    {
     ...
     */
    int GetNPCFlags(Forge* F, Creature* creature)
    {
        F->Push(creature->GetUInt32Value(UNIT_NPC_FLAGS));
        return 1;
    }
     ...
     */
    int GetExtraFlags(Forge* F, Creature* creature)
    {
        F->Push(creature->GetCreatureTemplate()->flags_extra);
        return 1;
    }
     ...
     * @return uint32 rank
     */
    int GetRank(Forge* F, Creature* creature)
    {
        F->Push(creature->GetCreatureTemplate()->rank);
        return 1;
    }
     ...
     */
    int GetShieldBlockValue(Forge* F, Creature* creature)
    {
        F->Push(creature->GetShieldBlockValue());
        return 1;
    }
     ...
     */
    int GetLootMode(Forge* F, Creature* creature)
    {
        F->Push(creature->GetLootMode());
        return 1;
    }
     ...
     */
    int GetDBTableGUIDLow(Forge* F, Creature* creature)
    {
        F->Push(creature->GetSpawnId());
        return 1;
    }
     ...
     */
    int SetNPCFlags(Forge* F, Creature* creature)
    {
        uint32 flags = F->CHECKVAL<uint32>(2);
     ...
     */
    int SetReactState(Forge* F, Creature* creature)
    {
     ...
     * @param bool disable
     */
    int SetDisableGravity(Forge* F, Creature* creature)
    {
        bool disable = F->CHECKVAL<bool>(2);
     ...
     * @param uint16 lootMode
     */
    int SetLootMode(Forge* F, Creature* creature)
    {
        uint16 lootMode = F->CHECKVAL<uint16>(2);
     ...
     */
    int SetDeathState(Forge* F, Creature* creature)
    {
        int32 state = F->CHECKVAL<int32>(2);
     ...
     */
    int SetWalk(Forge* F, Creature* creature)           // TODO: Move same to Player ?
    {
        bool enable = F->CHECKVAL<bool>(2, true);
     ...
     */
    int SetEquipmentSlots(Forge* F, Creature* creature)
    {
        uint32 main_hand = F->CHECKVAL<uint32>(2);
        uint32 off_hand = F->CHECKVAL<uint32>(3);
        uint32 ranged = F->CHECKVAL<uint32>(4);
     ...
     */
    int SetAggroEnabled(Forge* F, Creature* creature)
    {
        bool allow = F->CHECKVAL<bool>(2, true);
     ...
     */
    int SetDisableReputationGain(Forge* F, Creature* creature)
    {
        bool disable = F->CHECKVAL<bool>(2, true);
     ...
     */
    int SetInCombatWithZone(Forge* /*E*/, Creature* creature)
    {
     ...
     */
    int SetWanderRadius(Forge* F, Creature* creature)
    {
     ...
     */
    int SetRespawnDelay(Forge* F, Creature* creature)
    {
        uint32 delay = F->CHECKVAL<uint32>(2);
     ...
     */
    int SetDefaultMovementType(Forge* F, Creature* creature)
    {
        int32 type = F->CHECKVAL<int32>(2);
     ...
     */
    int SetNoSearchAssistance(Forge* F, Creature* creature)
    {
        bool val = F->CHECKVAL<bool>(2, true);
     ...
     */
    int SetNoCallAssistance(Forge* F, Creature* creature)
    {
        bool val = F->CHECKVAL<bool>(2, true);
     ...
     */
    int SetHover(Forge* F, Creature* creature)
    {
        bool enable = F->CHECKVAL<bool>(2, true);
     ...
     */
    int DespawnOrUnsummon(Forge* F, Creature* creature)
    {
        uint32 msTimeToDespawn = F->CHECKVAL<uint32>(2, 0);
     ...
     */
    int Respawn(Forge* /*E*/, Creature* creature)
    {
        creature->Respawn();
        return 0;
    }
     ...
     */
    int RemoveCorpse(Forge* /*E*/, Creature* creature)
    {
     ...
     */
    int MoveWaypoint(Forge* /*E*/, Creature* creature)
    {
     ...
     */
    int CallAssistance(Forge* /*E*/, Creature* creature)
    {
     ...
     * @param float radius
     */
    int CallForHelp(Forge* F, Creature* creature)
    {
     ...
     */
    int FleeToGetAssistance(Forge* /*E*/, Creature* creature)
    {
     ...
     * @param [Unit] target
     */
    int AttackStart(Forge* F, Creature* creature)
    {
        Unit* target = F->CHECKOBJ<Unit>(2);
     ...
     */
    int SaveToDB(Forge* /*E*/, Creature* creature)
    {
        creature->SaveToDB();
        return 0;
    }
     ...
     */
    int SelectVictim(Forge* F, Creature* creature)
    {
        F->Push(creature->SelectVictim());
        return 1;
    }
     ...
     */
    int UpdateEntry(Forge* F, Creature* creature)
    {
        uint32 entry = F->CHECKVAL<uint32>(2);
        uint32 dataGuidLow = F->CHECKVAL<uint32>(3, 0);
     ...
     */
    int ResetLootMode(Forge* /*E*/, Creature* creature)
    {
     ...
     * @param uint16 lootMode
     */
    int RemoveLootMode(Forge* F, Creature* creature)
    {
        uint16 lootMode = F->CHECKVAL<uint16>(2);
     ...
     * @param uint16 lootMode
     */
    int AddLootMode(Forge* F, Creature* creature)
    {
        uint16 lootMode = F->CHECKVAL<uint16>(2);
     ...
     */
    int GetCreatureFamily(Forge* F, Creature* creature)
    {
    ...
    */
    int RemoveFromWorld(Forge* F, Creature* creature)
    {
